...
\subsection{Comment et pourquoi change-t-on une centrale charbon en centrale biomasse ?}
...
\subsection{Quelles sont les émissions problématiques de la biomasse ?}
...
\subsection{Comment définir la biomasse ?}
...
\subsection{Toutes les biomasses ne sont pas équivalentes}
...
\subsection{D'où provient le bois-énergie utilisé en Belgique ?}
...
\subsection{Y a-t-il un lien avec le prix de la commode IKEA ?}
...
\subsection{Le problème récent du refus d'importation en Belgique}
...
\subsection{Les mécanismes de certification du bois}
...
\subsection{La biomasse, est-ce durable ?}
...
\subsection{Le trilemme de la biomasse}
...
\subsection{Les sources de chaleur verte}
...
\subsection{Les réseaux de chaleur, intéressant en Belgique ?}
...
\subsection{Le stockage d'énergie, important dans un monde renouvelable}
