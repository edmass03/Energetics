...
\subsubsection{Quel est le rôle du carbone dans la vie de recherche de Nathalie Job ?}
...
\subsubsection{Qu'est-ce qu'un xérogel ?}
...
\subsubsection{Quel était l'enjeu des xérogels en termes de surface et de porosité ?}
...
\subsubsection{Comment Nathalie Job est-elle entrée dans le domaine des piles à combustible ?}
...
\subsubsection{Comment fonctionne une pile à combustible ?}
...
\subsubsection{Pourquoi les piles à combustible sont-elles si coûteuses ?}
...
\subsubsection{Quels matériaux à longue durée de vie cherche-t-on dans les piles à combustible ?}
...
\subsubsection{Quelle est la chaîne de rendement dans une pile à combustible ?}
...
\subsubsection{Que fait-on concrètement dans le projet Be Hyfe pour prolonger la durée de vie des catalyseurs ?}
...
\subsubsection{L'objectif est-il de limiter la masse de platine utilisée ?}
...
\subsubsection{Existe-t-il une alternative viable au platine ?}
...
\subsubsection{Quel est le point de vue de Nathalie Job sur l'utilisation de l'hydrogène ?}
...
\subsubsection{Comment fonctionne l'électrolyse ? Est-ce l'inverse de la pile à combustible ?}
...
\subsubsection{Dans quelles applications un système réversible électrolyse/pile à combustible serait-il pertinent ?}
...
\subsubsection{Quel est le lien entre les activités sur les batteries et sur les piles à combustible ?}
...
\subsubsection{Comment fonctionne une batterie lithium-ion ?}
...
\subsubsection{Comment sait-on qu'une batterie est complètement chargée ?}
...
\subsubsection{Quels sont les effets de la température sur les batteries ?}
...
\subsubsection{Existe-t-il une alternative aux électrolytes liquides inflammables ?}
...
\subsubsection{Quel est le point de vue de Nathalie Job sur la sécurité des batteries domestiques ?}
...
\subsubsection{Pourquoi les batteries perdent-elles de leurs performances avec le temps ?}
...
\subsubsection{La plage de charge et décharge est-elle réduite avec le temps ?}
...
\subsubsection{Faut-il éviter de charger et décharger trop rapidement ?}
...
\subsubsection{Que fait-on pour optimiser le BMS et faire le lien avec la charge rapide ?}
...
\subsubsection{Quelles autres avancées perçoit-on pour les batteries dans le futur ?}
...
\subsubsection{Est-il réaliste de ne plus vendre de voitures à combustion à partir de 2035 ?}
...
\subsubsection{Le projet de « peindre » des batteries : de quoi s'agit-il ?}
...
\subsubsection{Une spin-off a-t-elle été lancée suite au dépôt de brevet ?}
...
\subsubsection{Quels matériaux sont particulièrement sensibles et font l'objet de recherches ?}
...
\subsubsection{L'industrialisation du procédé a-t-elle été envisagée ?}
...
\subsubsection{La technologie seule peut-elle résoudre le problème énergétique ?}
...
\subsubsection{Quels changements de croyances ou d'habitudes Nathalie Job a-t-elle entrepris ces dernières années ?}
...
\subsubsection{Quels livres conseille Nathalie Job ?}
...
\subsubsection{Quelle phrase Nathalie Job écrirait-elle sur tous les tableaux de l'université ?}
...
\subsubsection{Quel hobby a influencé la personnalité de Nathalie Job ?}
