...
\subsection{Le Carbon Removal X Prize d'Elon Musk}
...
\subsection{L'équipe internationale YUMET}
...
\subsection{Remerciements à Lionel pour son cadeau Climeworks}
...
\subsection{La cimenterie : un secteur \textit{hard to abate}}
...
\subsection{La thèse de Lionel Dubois}
...
\subsection{L'échelle TRL (\textit{Technology Readiness Level})}
...
\subsection{Article sur la capture directe du CO\texorpdfstring{\textsubscript{2}}{2} dans les camions}
...
\subsection{Le prix du CO\texorpdfstring{\textsubscript{2}}{2}}
...
\subsection{Les normes de qualité du CO\texorpdfstring{\textsubscript{2}}{2}}
